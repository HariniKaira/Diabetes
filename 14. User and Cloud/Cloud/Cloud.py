...
root.title("Ensemble Fraemwork-based Diabetes Detection and Diet Plan Suggestion for Healthcare Big Data Clouds")
...
font = ('times', 18, 'bold')
title = Label(root, text='Diabetes Detection and Diet Plan Suggestion for Healthcare using Big Data Clouds')
